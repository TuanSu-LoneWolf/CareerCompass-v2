...
export function Input({
  ...
  const base =
    "w-full px-3 py-2 rounded-md border outline-none transition text-gray-700 placeholder-gray-400 disabled:bg-gray-100 disabled:cursor-not-allowed flex items-center gap-2";
